  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
      ...
      >
          ...
          <View style={styles.formContainer}>
            ...
            {displayError ? (
              <Animated.View style={[styles.errorBanner, { opacity: errorOpacity }]}>
                <Text style={[styles.errorBannerText, { color: theme.error }]}>{displayError}</Text>
              </Animated.View>
            ) : null}
        ...
        {/* Выбор языка доступен ДО входа: иначе пользователь, которому
            интерфейс достался не на его языке, не может это исправить — в
            настройки он попадёт только после авторизации. */}
...
const styles = StyleSheet.create({
  ...
  errorBannerText: {
    // Цвет приходит из темы в JSX — StyleSheet статичен и тему не видит.
    fontSize: 14,
    fontWeight: '500',
    textAlign: 'center',
  },
