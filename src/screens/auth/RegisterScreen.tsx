...
export function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      // authStore.register принимает позиционные аргументы, а не объект.
      // Имя и фамилия сейчас на сервер не уходят — их приём в
      // POST api/node/auth/register надо будет добавить отдельно (на Android
      // они передаются) и тогда расширить сигнатуру здесь.
