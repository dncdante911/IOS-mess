const en = {
  ...
  login_verify_title: 'Sign-in verification',
  login_verify_sent_email: 'We sent a verification code to your email.',
  login_verify_sent_email_addr: 'We sent a verification code to {email}.',
  login_verify_sent_device: 'We sent a verification code to your other active device.',
  login_verify_sent_both: 'We sent a code to your other active device and to {email}.',
  login_verify_resend_email: 'Send the code to my email',
  login_verify_back: '← Back to sign in',
